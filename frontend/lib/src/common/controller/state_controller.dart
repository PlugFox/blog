...
abstract base class StateController<S extends Object> extends Controller implements IStateController<S> {
  ...
  late final List<StreamController<S>> _$streamControllers = <StreamController<S>>[];

  /// Returns a [ValueListenable] view of this controller's state.
  ValueListenable<S> toValueListenable() => _StateController$ValueListenableView<S>(this);
...
final class _StateController$ValueListenableView<S extends Object> implements ValueListenable<S> {
...
final class _StateController$ValueListenableSelect<S extends Object, Value>
  ...
  @override
  Value get value => _subscribed ? _$value : _$value = _selector(_controller.state);
