...
mixin class ChangeNotifier implements Listenable {
  ...
  @override
  void addListener(VoidCallback listener) {
    assert(ChangeNotifier.debugAssertNotDisposed(this), 'A $runtimeType was used after being disposed.');
  ...
  void notifyListeners() {
    ...
    for (var i = 0; i < end; i++) {
      try {
        ...
        log('Error while dispatching notifications', error: exception, stackTrace: stack);
      }
    }
